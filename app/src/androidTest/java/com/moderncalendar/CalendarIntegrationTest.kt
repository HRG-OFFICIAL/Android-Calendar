...
class CalendarIntegrationTest {
    ...
    @Test
    fun `create and retrieve event should work correctly`() =
        runTest {
            // Given
            val testEvent =
                EventEntity(
    ...
    @Test
    fun `update event should modify existing event`() =
        runTest {
            // Given
            val originalEvent =
                EventEntity(
    ...
    @Test
    fun `delete event should remove event from database`() =
        runTest {
            // Given
            val testEvent =
                EventEntity(
    ...
    @Test
    fun `search events should return matching events`() =
        runTest {
            // Given
            val events =
                listOf(
    ...
    @Test
    fun `get events by date range should return events within range`() =
        runTest {
            // Given
            val events =
                listOf(
