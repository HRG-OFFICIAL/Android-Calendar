...
class SearchViewModelTest {
    ...
    @Test
    fun `searchEventsWithFilters filters by query correctly`() = runTest {
    ...
    @Test
    fun `searchEventsWithFilters filters by priority correctly`() = runTest {
        coEvery { eventRepository.getAllEvents() } returns flowOf(Result.Success(sampleEvents))
    ...
    @Test
    fun `searchEventsWithFilters filters by date range correctly`() = runTest {
        coEvery { eventRepository.getAllEvents() } returns flowOf(Result.Success(sampleEvents))
    ...
    @Test
    fun `searchEventsWithFilters filters by start date only`() = runTest {
        coEvery { eventRepository.getAllEvents() } returns flowOf(Result.Success(sampleEvents))
    ...
    @Test
    fun `searchEventsWithFilters filters by end date only`() = runTest {
        coEvery { eventRepository.getAllEvents() } returns flowOf(Result.Success(sampleEvents))
    ...
    @Test
    fun `searchEventsWithFilters combines multiple filters`() = runTest {
        coEvery { eventRepository.getAllEvents() } returns flowOf(Result.Success(sampleEvents))
    ...
    @Test
    fun `searchEventsWithFilters returns empty list when no matches`() = runTest {
        coEvery { eventRepository.getAllEvents() } returns flowOf(Result.Success(sampleEvents))
    ...
    @Test
    fun `searchEventsWithFilters handles repository error`() = runTest {
