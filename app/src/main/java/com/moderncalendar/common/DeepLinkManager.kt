...
class DeepLinkManager @Inject constructor() {
    ...
    private fun handleModernCalendarScheme(context: Context, uri: Uri): Boolean {
    ...
    private fun handleHttpScheme(context: Context, uri: Uri): Boolean {
        return when {
    ...
    private fun handleContentScheme(context: Context, uri: Uri): Boolean {
        return when (uri.host) {
            "com.moderncalendar" -> {
                openMainActivity(context)
                true
    ...
    private fun openEvent(context: Context, eventId: String) {
