...
class CalendarViewModelTest {
    ...
    @Test
    fun `selectDate updates selectedDate state`() =
        runTest {
            // Given
    ...
    @Test
    fun `navigateToToday sets selectedDate to current date`() =
        runTest {
            // Given
    ...
    @Test
    fun `createEvent calls repository insertEvent`() =
        runTest {
            // Given
            val testEvent =
                Event(
    ...
    @Test
    fun `loadEventsForSelectedDate updates events state`() =
        runTest {
            // Given
            val testEvents =
                listOf(
    ...
    @Test
    fun `deleteEvent calls repository deleteEvent`() =
        runTest {
            // Given
