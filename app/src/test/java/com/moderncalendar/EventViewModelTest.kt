...
class EventViewModelTest {
    ...
    @Test
    fun `loadEvents should fetch all events from repository`() =
        runTest {
            // Given
            val testEvents =
                listOf(
    ...
    @Test
    fun `updateEvent should call repository and refresh events`() =
        runTest {
            // Given
            val testEvent =
                Event(
    ...
    @Test
    fun `getEventById should load specific event`() =
        runTest {
            // Given
            val eventId = "test-event-id"
            val testEvent =
    ...
    @Test
    fun `selectEvent should update selected event`() =
        runTest {
            // Given
            val testEvent =
                Event(
    ...
    @Test
    fun `clearSelectedEvent should clear selected event`() =
        runTest {
            // Given
            val testEvent =
                Event(
    ...
    @Test
    fun `loadEventsByDateRange should fetch events for specific range`() =
        runTest {
            // Given
