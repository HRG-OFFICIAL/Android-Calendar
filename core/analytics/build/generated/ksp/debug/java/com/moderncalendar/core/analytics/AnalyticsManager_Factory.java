...
public final class AnalyticsManager_Factory implements Factory<AnalyticsManager> {
  ...
  public static AnalyticsManager_Factory create(
      javax.inject.Provider<FirebaseAnalytics> firebaseAnalyticsProvider,
      javax.inject.Provider<FirebaseCrashlytics> crashlyticsProvider) {
    return new AnalyticsManager_Factory(Providers.asDaggerProvider(firebaseAnalyticsProvider), Providers.asDaggerProvider(crashlyticsProvider));
  }
