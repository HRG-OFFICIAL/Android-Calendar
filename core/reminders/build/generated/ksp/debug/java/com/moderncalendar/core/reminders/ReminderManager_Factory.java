...
public final class ReminderManager_Factory implements Factory<ReminderManager> {
  ...
  public static ReminderManager_Factory create(javax.inject.Provider<Context> contextProvider,
      javax.inject.Provider<AlarmManager> alarmManagerProvider) {
    return new ReminderManager_Factory(Providers.asDaggerProvider(contextProvider), Providers.asDaggerProvider(alarmManagerProvider));
  }
